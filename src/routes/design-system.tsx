...
const pages: PageRow[] = [
  ...
  { label: "Gardsforsaljare", route: "/gardsforsaljare", example: "/gardsforsaljare", dynamic: false },
  { label: "Gardsforsaljare (dynamisk)", route: "/gardsforsaljare/$slug", example: `/gardsforsaljare/${farms[0]?.slug ?? ""}`, dynamic: true },
