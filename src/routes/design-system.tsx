...
const pages: PageRow[] = [
  ...
  { label: "Gardsforsaljare", route: "/producenter", example: "/producenter", dynamic: false },
  { label: "Gardsforsaljare (dynamisk)", route: "/producenter/$slug", example: `/producenter/${farms[0]?.slug ?? ""}`, dynamic: true },
