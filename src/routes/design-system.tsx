...
const pages: PageRow[] = [
  ...
  { label: "Gårdsförsäljare", route: "/gardsforsaljare", example: "/gardsforsaljare", dynamic: false },
  { label: "Gårdsförsäljare (dynamisk)", route: "/gardsforsaljare/$slug", example: `/gardsforsaljare/${farms[0]?.slug ?? ""}`, dynamic: true },
