...
import { categories, farms } from "@/data/site"; import type { Farm } from "@/data/site";
    ...
    <PageLayout>
      ...
      <section className="section-pad">
        <div className="container-x">
          {list.length === 0 ? (
            <p className="text-body">Vi listar snart producenter inom {cat.name.toLowerCase()}. <Link to="/gardar" className="text-primary underline">Visa alla producenter</Link></p>
          ) : (
