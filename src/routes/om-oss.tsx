...
export const Route = createFileRoute("/om-oss")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "En guide till Sveriges lokala dryckesgårdsförsäljare." },
    ],
  }),
  component: OmOssPage,
});
  ...
  return (
    <PageLayout>
      <PageHero
        ...
        lead="Vår mission är att göra det enklare för svenskar att hitta, besöka och stötta gårdsförsäljare som öppnar dörrarna för gårdsförsäljning."
      />
      <section className="section-pad">
        <div className="container-x grid md:grid-cols-3 gap-8">
          {[
            { icon: Sprout, t: "Närproducerat", d: "Vi listar enbart svenska gårdsförsäljare som tillverkar drycker med tydligt lokal anknytning." },
        ...
        <div className="container-x grid lg:grid-cols-[1.2fr_1fr] gap-12 items-start">
          <div className="prose-like max-w-2xl">
            ...
            <p className="text-body leading-relaxed">
              ...
              att det saknades en plats där besökare enkelt kunde hitta vilka gårdsförsäljare som faktiskt öppnar
            ...
            <p className="text-body leading-relaxed mt-4">
              ...
              både hjälpa dig som besökare och stötta de gårdsförsäljare som vågar satsa på närodlat och hantverk.
            </p>
          </div>
          <div className="bg-primary text-primary-foreground rounded-2xl p-8">
            <h3 className="font-display text-2xl text-primary-foreground mb-3">Är du gårdsförsäljare?</h3>
